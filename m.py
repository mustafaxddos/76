...
TELEGRAM_BOT_TOKEN = '7718655847:AAGf4kBc5UUL80Nhxbq03f3S9Bj3STHR8y0'
...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        ...
        return
    message = (
        f"*🔥 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐓𝐇𝐑 𝐁𝐀𝐓𝐓𝐋𝐄𝐅𝐈𝐄𝐋𝐃, {user_name}! 🔥*\n\n"
             "*𝐔𝐒𝐄 /𝐚𝐭𝐭𝐚𝐜𝐤 <𝐢𝐩> <𝐩𝐨𝐫𝐭> <𝐝𝐮𝐫𝐚𝐭𝐢𝐨𝐧>*\n" 
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id in cooldown_dict:
        ...
        if time_diff < cooldown_period:
            ...
            await context.bot.send_message(
                chat_id=chat_id,
                text=f"*⏳ 𝐖𝐀𝐈𝐓 𝐁𝐑𝐎𝐖 {remaining_time}*",
                parse_mode='Markdown'
            )
            return
    ...
    chat_id=chat_id,
    text=(
        f"*💀 𝐖𝐀𝐑𝐍𝐈𝐍𝐆: 𝐓𝐇𝐄 𝐄𝐍𝐃 𝐈𝐒 𝐍𝐈𝐆𝐇! 💀*\n"
        f"*🎯 𝐓𝐀𝐑𝐆𝐄𝐓 𝐋𝐎𝐂𝐊𝐄𝐃: {ip}:{port}*\n"
        f"*⏳ 𝐂𝐎𝐔𝐍𝐓𝐃𝐎𝐖𝐍: {duration} seconds*\n"
        f"*🔥 𝐆𝐄𝐓 𝐑𝐄𝐀𝐃𝐘 𝐅𝐈𝐑 𝐏𝐔𝐑𝐄 𝐃𝐄𝐕𝐀𝐒𝐓𝐀𝐓𝐈𝐎𝐍. 💥*\n"
        f"*⚠️ 𝐘𝐎𝐔’𝐕𝐄 𝐉𝐔𝐒𝐓 𝐒𝐈𝐆𝐍𝐄𝐃 𝐘𝐎𝐔𝐑 𝐃𝐄𝐀𝐓𝐇 𝐖𝐀𝐑𝐑𝐀𝐍𝐓. ⚠️*"
    ),
    parse_mode='Markdown'
)
